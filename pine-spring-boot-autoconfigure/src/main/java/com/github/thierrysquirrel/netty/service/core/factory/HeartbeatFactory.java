...
package com.github.thierrysquirrel.netty.service.core.factory;

import com.github.thierrysquirrel.core.constant.MapSizeConstant;
import lombok.Data;
...
public class HeartbeatFactory {
    ...
    private static Map<String, List<String>> clientServiceNameMap = new ConcurrentHashMap<> (MapSizeConstant.DEFAULT_SIZE.getValue ());
    private static Map<String, Integer> heartbeatMap = new ConcurrentHashMap<> (MapSizeConstant.DEFAULT_SIZE.getValue ());
